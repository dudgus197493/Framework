...
public class MyPageController {
	...
	public String updateProfile(@RequestParam("profileImage") MultipartFile profileImage, /* 업로드된 파일 */
			@SessionAttribute("loginMember") Member loginMember, /* 회원 번호 필요 */
		...
		// .getRealPath("경로"); : 해당경로의 폴더가 실제 컴퓨터상에서 어디에 있는가
